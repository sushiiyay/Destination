 ...
 * @date 2026-06-08
 *
 * @copyright nihla.fatiha.ft25@mail.umy.ac.id (d) 2026
 *
 */
...
{      
    ...
    void remove()
    {
        ...
        {
            // jika elemen yang dihapus berada di posisi terahir array, kembali ke awal array
            if (FRONT == max - 1)
                FRONT = 0;
            else
                FRONT = FRONT + 1;
     ...
     * data tampilan yang berada dalam variable queue_array
     */
    void display()
    {
        ...
        {
            // jika FRONT <= REAR, iterasi dar FRONT hingga akhir array
